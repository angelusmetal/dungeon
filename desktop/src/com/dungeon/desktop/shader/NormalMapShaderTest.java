...
public class NormalMapShaderTest extends ApplicationAdapter implements InputProcessor {
	...
	public static void main(String[] arg) {
		...
		config.width = 1800;
		config.height = 900;
		new LwjglApplication(new NormalMapShaderTest(), config);
	}
...
//	private final LightRenderer renderer = new LightRenderer();
	...
	public void create () {
		Resources.initAtlas();
		shaderProgram = Resources.shaders.get("df_vertex.glsl|light/normal_mapper.glsl");
		sprite = Resources.loadSprite("cobblestone_floor_b", 0);
