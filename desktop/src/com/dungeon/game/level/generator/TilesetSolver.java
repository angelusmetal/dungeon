...
public class TilesetSolver {
	private final Function<Tileset, Animation<TextureRegion>>[] animations;
	...
	public Animation<TextureRegion> getTile(TileType[][] tiles, Predicate<TileType> predicate, int x, int y, int width, int height, Tileset tileset) {
