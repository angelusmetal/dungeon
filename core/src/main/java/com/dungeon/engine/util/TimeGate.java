...
public class TimeGate {
	...
	/**
	 * Attempt action; if gate is open, the action will be executed and the gate will close for the specified amount of
	 ...
	 * @param action Action to execute (only if gate is open).
	 */
