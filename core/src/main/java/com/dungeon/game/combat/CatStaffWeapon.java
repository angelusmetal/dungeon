...
public class CatStaffWeapon extends ProjectileWeapon {
	...
	public CatStaffWeapon() {
		...
		Light bulletLight = new Light(60, new Color(0.8f, 0.2f, 0.8f, 0.5f), Light.FLARE);
		...
		projectile = new EntityPrototype()
				...
				.with(Traits.autoSeek(0.1f, 60, () -> GameState.entities.all().filter(PlayerEntity.TARGET_NON_PLAYER_CHARACTERS)))
