...
public class DynamicLightDemo extends ApplicationAdapter implements InputProcessor, ControllerListener {
    ...
    private class Light {
        ...
        public Light(RenderLight light) {
            ...
            this.horizontal = random(1f) > 0.5f;
            this.phase = random(200f);
        }
        public void flicker() {
        ...
        public void update() {
            renderLight.getOrigin().set(origin);
            if (horizontal) {
                renderLight.getOrigin().x += sin(time / 3f + phase) * 300;
            } else {
                renderLight.getOrigin().y += sin(time / 3f + phase) * 300;
            }
        }
    }
    ...
    public void create () {
        ...
        lightRenderer.setAmbient(new Color(0f, 0f, 0.1f, 1f));
